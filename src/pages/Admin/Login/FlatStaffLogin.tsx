...
const FlatStaffLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await FlatStaffAuthService.login(formData);
      if (response.success) {
        // Lưu thông báo vào sessionStorage thay vì hiện ngay
        sessionStorage.setItem('adminLoginSuccess', JSON.stringify({
          message: 'Đăng nhập thành công! Chào mừng bạn đến với Staff Admin Dashboard.',
          timestamp: Date.now()
        }));
  ...
  const features = [
    {
      ...
      description: 'Xử lý và theo dõi đơn hàng một cách hiệu quả',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: 'Quản lý sản phẩm',
      description: 'Kiểm soát sản phẩm và cửa hàng từ một nền tảng',
      color: 'from-purple-500 to-pink-500'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Chiến dịch khuyến mãi',
      description: 'Tạo và quản lý các chiến dịch marketing hiệu quả',
      color: 'from-orange-500 to-red-500'
    },
    {
      icon: <ShieldCheck className="w-6 h-6" />,
      title: 'Bảo mật cao',
      description: 'Hệ thống được bảo vệ với mã hóa và xác thực đa lớp',
          ...
          <div>
            <div className="flex items-center space-x-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-purple-200">Staff Admin Dashboard</p>
              </div>
            </div>
            ...
            <div className="max-w-md">
              ...
              <p className="text-lg text-slate-300 leading-relaxed">
                Công cụ hỗ trợ bạn quản lý đơn hàng, sản phẩm và chiến dịch một cách hiệu quả
              </p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900">AudioStore Staff Admin</h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="staffadmin@audiostore.com"
                  />
                </div>
              </div>
