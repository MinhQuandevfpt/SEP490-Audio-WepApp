...
const GoogleLoginButton = ({ 
  ...
  return (
    <button
      ...
      className={`w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200 shadow-sm ${className}`}
    >
