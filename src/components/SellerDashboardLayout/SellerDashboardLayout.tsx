...
const SellerDashboardLayout: React.FC = () => {
  ...
  const [notificationsLoading, setNotificationsLoading] =
    useState<boolean>(false); // Loading state cho notifications
    ...
    () => [
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Thêm sản phẩm", path: "/seller/dashboard/products/add" },
          {
            ...
            path: "/seller/dashboard/products/update",
          },
          {
            label: "Sản phẩm hết hàng",
            path: "/seller/dashboard/products/out-of-stock",
          },
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            label: "Chờ lấy hàng",
            path: "/seller/dashboard/orders/processing",
          },
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Tạo nhân viên", path: "/seller/dashboard/staff/create" },
          {
            ...
            path: "/seller/dashboard/staff/update",
          },
          {
            label: "Xóa thông tin nhân viên",
            path: "/seller/dashboard/staff/delete",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Voucher", path: "/seller/dashboard/marketing/vouchers" },
          {
            ...
            path: "/seller/dashboard/shop-wide-voucher",
          },
        ],
      },
      {
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {notifications.map((notification) => (
                          <button
                            ...
                            className={`w-full text-left px-4 py-3 border-b border-gray-100 transition-colors ${getNotificationBgColor(
                              notification.type,
                              notification.read
                            )}`}
                          >
